...
rootdir = '/media/geancarlo/OS_Install/Users/geancarlo/Desktop/tweets/cuenca_1'  # carpeta con subcarpetas de tweets
'''
> tweets
    > guayaquil_1
    > quito_1
...
tweets_file.write('screen_name,tweet,favorite_count,retweet_count,reply_to,n_user_mentions,n_hashtags,n_urls,user_mentions,hashtags,place\n')
